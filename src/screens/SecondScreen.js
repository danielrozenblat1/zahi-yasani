...
<div className={styles.description}>תמיד יש מה לשפר ולאן להתפתח אבל אם לא נעשה את הצעד הראשון אז לא נגיע למקום שאנחנו רוצים להגיע אליו</div>

            <div className={styles.description}>
                הדרך להצלחה מתחילה בצעדים קטנים. אני כאן ללוות אותך בכל שלב.
            </div>
            <div className={styles.description}>
            במרחב שלי נערות, נשים, משפחות, ימצאו סביבה בטוחה ומחזקת שבהן יוכלו לחקור את חלומותיהן, להתמודד עם אתגרים ולפתח את היכולות הייחודיות שלהן.
            </div>
            <div className={styles.description}>
