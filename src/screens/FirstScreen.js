...
const FirstScreen = (props) => {
    ...
    return (
        <div className={props.scrolled ? styles.containerP : styles.container}>
            ...
            <div className={styles.description}>כמנחה להתפתחות אישית ומייסדת מרחב "לחיות את האדם שאתה חולם להיות", אני ממוקדת בהענקת כלים מעשיים ומעמיקים שמאפשרים לכל אחת ואחד לממש את הפוטנציאל האישי שלהם.  <br/> אני מאמינה שכל אדם נושא בתוכו את הכוח לשינוי, לי יש את הידע והניסיון להנחות אתכם בדרך זו.</div>
