      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            נשואה + , בעלת תואר ראשון במדעי התנהגות, תואר שני ביעוץ משפחתי, מנחה קבוצות מוסמכת,מנטורית להתפתחות אישית,
            יועצת פיתוח קהילות בתוך עמותות ורשויות ומרצה.
          </p>
          <p className={styles.description}>
          ...
          <p className={styles.description}>
            מפה אני יוצאת איתכם למסע שמעיר ומאיר את הדרך, למי? לאדם שאתם מייחילים להיות.
            ...
            אל תבזבזו זמן ואנרגייה על מתי, איך, למה וכמה, פשוט תעשו את הצעד
          </p>
        </div>
      </div>
